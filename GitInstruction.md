...
Теперь данную новую информацию я хочу добавить на свою локальную. делаю следую следующую команду git pull. __*(перед этим конечно же ctrl+s, git add . , git commit)*__
